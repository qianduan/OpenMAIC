export const generationZhCN = {
  ...
  upload: {
    ...
    requirementPlaceholder: '请描述您希望生成的课程内容，例如：\n• 课程主题和核心内容\n• 期望的课程时长和风格\n• 任何特殊要求或偏好',
...
export const generationEnUS = {
  ...
  upload: {
    ...
    requirementPlaceholder: 'Describe the course you want to generate, for example:\n• Course topic and core content\n• Expected duration and teaching style\n• Any special requirements or preferences',
