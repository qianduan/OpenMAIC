...
export function EditableElement({ elementInfo, elementIndex, isMultiSelect, selectElement, openLinkDialog }: EditableElementProps) {
  ...
  const {copyElement, pasteElement, cutElement, deleteElement, 
    lockElement, unlockElement, selectAllElements, 
    alignElementToCanvas, orderElement, combineElements, uncombineElements,
  } = useCanvasOperations();
  ...
  const contextmenus = (): ContextmenuItem[] => {
    ...
    return [
      ...
      { divider: true },
      {
        ...
        children: [
          { text: '置于顶层', handler: () => orderElement(elementInfo, ElementOrderCommands.TOP) },
          { text: '上移一层', handler: () => orderElement(elementInfo, ElementOrderCommands.UP) },
        ],
      },
      {
        text: '置于底层',
        ...
        children: [
          { text: '置于底层', handler: () => orderElement(elementInfo, ElementOrderCommands.BOTTOM) },
          { text: '下移一层', handler: () => orderElement(elementInfo, ElementOrderCommands.DOWN) },
        ],
      },
      { divider: true },
      {
